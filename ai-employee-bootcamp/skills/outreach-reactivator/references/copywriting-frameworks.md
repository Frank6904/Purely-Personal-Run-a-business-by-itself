...
**Example:**
```
Problem:  You've been posting on LinkedIn for 6 months. Solid engagement. Zero leads.
Agitate:  Every like feels good until Friday when you check your calendar and there's
          nothing in it. You're building an audience. Not a business.
Solution: The problem isn't your content. It's your profile. Here's what to fix first.
```
...
**Example:**
```
Before:  Marcus was posting 4x per week. Good engagement. Zero inbound calls in 3 months.
After:   60 days later: 8 inbound discovery calls in one month. 3 converted to clients.
Bridge:  He changed one thing. Not his posting frequency. His profile headline.
         One sentence that finally told the right people exactly what he did for them.
```
...
**Structure:**
```
Promise:  State the specific outcome the reader will get (1 sentence)
Picture:  Make them feel what it's like to have that outcome (2–3 sentences)
Proof:    Provide the evidence that this is real (2–3 sentences)
Push:     Tell them exactly what to do next (1 sentence)
```
...
Proof:    This is what happened for 7 of my clients after we optimised their profile and
          built a 3-post-per-week system. Average time to first inbound: 6 weeks.
Push:     DM me LEADS and I'll send you the exact 3-step process.
```
...
**Example:**
```
Setup:   I had my best month of LinkedIn engagement in March. 40,000 impressions.
         More comments than I'd ever had. I assumed the leads would follow.
         They didn't. Not one.

Mistake: I was optimising for engagement. Likes and comments feel like progress.
         They're not pipeline.

Lesson:  Engagement tells you your content is interesting.
         Conversion tells you your content is useful to the right person.
         They're completely different metrics with completely different post structures.
...
Reframe:  What actually builds a following early: one exceptional post per week that
          reaches beyond your network. One post that gets reshared, commented on by
...
**Example:**
```
Subject:  A fractional CMO with 14 years experience and a profile that looked like it
          belonged to a recent graduate.

Problem:  "People see my title and assume I'm expensive before they've heard my value.
           I'm losing deals before they even start." She'd been told her content was good.
           The problem wasn't content. It was first impression.

Process:  We rewrote her headline to lead with the specific problem she solves for scale-ups
          rather than her job title. Rebuilt her about section to open with the buyer's
          exact frustration. Added three client results in the first paragraph.

Result:   Profile views up 340% in 3 weeks. Two inbound DMs in the first 10 days from
          exactly the profile of client she'd been chasing through cold outreach.

Takeaway: Your title is irrelevant to your buyer. The problem you solve is everything.
```
...
Close loop:  Connect the story back to the reader's situation (2–3 sentences)
```

**Example of Open Loop (not from the beginning):**
```
Wrong: "Let me tell you about my client Sarah. She started her business in 2019..."
Right: "Sarah was on the phone with her third dream client in 30 days. She'd changed nothing about her offer, her pricing, or her outreach. Just her LinkedIn profile."
```
...
| If the content is... | Use this framework |
|----------------------|-------------------|
| A specific client win | BAB or Case Study |
| A lesson from a mistake | Teachable Moment |
| A contrarian opinion | Contrarian Take |
| Targeting a specific pain | PAS |
| Promoting an offer | 4 Ps |
| A how-to or process | Numbered Framework |
| A story or narrative | Story Loop |
| A carousel or cheatsheet | Numbered Framework |

**When in doubt:** use PAS for posts, BAB for newsletters, Numbered Framework for carousels.
